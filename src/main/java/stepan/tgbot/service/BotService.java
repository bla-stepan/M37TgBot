...
import stepan.tgbot.entity.ActiveChat;
import stepan.tgbot.repository.ActiveChatRepository;
    ...
    public void onUpdateReceived(Update update) {
        ...
        try {
            ...
            if (activeChatRepository.findActiveChatByChatId(chatId).isEmpty()) {
                ...
                activeChatRepository.save(activeChat);//возникает ошибка при сохранении
            }
        } catch (Exception e) {
